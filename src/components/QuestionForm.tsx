            ...
            <Container>
                ...
                <FormControl>
                    ...
                    <Select
                        ...
                        onChange={(e) => actions({type:'setState', payload: {...state, fingerprints: e.target.value}})}
                        // inputProps={{
                        //     name: 'fingerprints',
                        //     id: 'fingerprints'
                        // }}
                ...
                <FormControl>
                    ...
                    <Select
                        ...
                        onChange={(e) => actions({type:'setState', payload: {...state, passport: e.target.value}})}
                        // inputProps={{
                        //     name: 'passport',
                        //     id: 'passport'
                        // }}
                ...
                <FormControl>
                    ...
                    <Select
                        native
                        value={state.under18}
                        onChange={(e) => actions({type:'setState', payload: {...state, under18: e.target.value}})}
                        // inputProps={{
                        //     name: 'under18',
                        //     id: 'under18'
                        // }}
                ...
                <FormControl>
                    ...
                    <Select
                        ...
                        onChange={(e) => actions({type:'setState', payload: {...state, familyInGermany: e.target.value}})}
                        // inputProps={{
                ...
                <FormControl>
                    ...
                    <Select
                        ...
                        onChange={(e) => actions({type:'setState', payload: {...state, familyElsewhere: e.target.value}})}
                        // inputProps={{
                ...
                <FormControl>
                    ...
                    <TextField
                        ...
                        onChange={(e) => actions({type:'setState', payload: {...state, adviceLocation: e.target.value}})}
                        // inputProps={{
                        //     name: 'adviceLocation',
                        //     id: 'advice-location'
                        // }}
